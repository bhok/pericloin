...
This document provides guidelines for internationalization of the Pericloin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pericloin_en.ts` remains unchanged.
