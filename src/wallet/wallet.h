...
#ifndef PERICLOIN_WALLET_WALLET_H
#define PERICLOIN_WALLET_WALLET_H
...
public:
     ...
     * on this pericloin node, and set to 0 for transactions that were created
...
#endif // PERICLOIN_WALLET_WALLET_H
