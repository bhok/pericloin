...
#ifndef PERICLOIN_QT_PERICLOINUNITS_H
#define PERICLOIN_QT_PERICLOINUNITS_H
...
/** Pericloin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PericloinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PericloinUnits(QObject *parent);

    /** Pericloin units.
      @note Source: https://en.pericloin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PRC,
...
typedef PericloinUnits::Unit PericloinUnit;

#endif // PERICLOIN_QT_PERICLOINUNITS_H
