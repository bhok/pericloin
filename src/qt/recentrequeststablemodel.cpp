    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return PericloinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, PericloinUnits::separatorNever);
            else
                return PericloinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+PericloinUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
