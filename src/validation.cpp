...
#if defined(NDEBUG)
# error "Pericloin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pericloin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s PRC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("pericloin-scriptch");
