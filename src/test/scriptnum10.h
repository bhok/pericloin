...
#ifndef PERICLOIN_TEST_SCRIPTNUM10_H
#define PERICLOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pericloin Core 0.10.0, for cross-comparison.
 */
public:
