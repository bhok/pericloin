...
{
    BOOST_CHECK(TestSplitHost("www.pericloin.org", "www.pericloin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.pericloin.org]", "www.pericloin.org", -1));
    BOOST_CHECK(TestSplitHost("www.pericloin.org:80", "www.pericloin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.pericloin.org]:80", "www.pericloin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8888", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8888", "127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8888", "::ffff:127.0.0.1", 8333));
    BOOST_CHECK(TestSplitHost("[::]:8888", "::", 8333));
    BOOST_CHECK(TestSplitHost("::8888", "::8333", -1));
    BOOST_CHECK(TestSplitHost(":8888", "", 8333));
    BOOST_CHECK(TestSplitHost("[]:8888", "", 8333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8888", "127.0.0.1:8333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8888", "[::]:8333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
