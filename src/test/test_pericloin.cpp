...
#define BOOST_TEST_MODULE Pericloin Test Suite

#include "test_pericloin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_pericloin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
