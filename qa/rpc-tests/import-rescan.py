...
import RPC call and node 0 sends PRC to it. Then other nodes import the
...
In the second part of the test, node 0 sends more PRC to each address, and the
...
class ImportRescanTest(PericloinTestFramework):
    def __init__(self):
        super().__init__()
