...
class RawTransactionsTest(PericloinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid pericloin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid pericloin address" in e.error['message'])
